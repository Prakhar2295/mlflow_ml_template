...
def main(p1,p2):
    with mlflow.start_run():
        mlflow.log_param('param1',p1)   ##key and value
        mlflow.log_param('param2',p2)    ##key and value
        
        metric = evaluate(param1 = p1,param2 = p2)
        mlflow.log_metric('somemetrics',metric)    ##key and value
        
        os.makedirs("temp", exist_ok = True)
        with open("temp/sample.txt",'a+') as f:
